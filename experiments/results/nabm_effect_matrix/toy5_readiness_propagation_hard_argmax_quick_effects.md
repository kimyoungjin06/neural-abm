...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| toy5_readiness_propagation_hard_argmax | toy5 | domain_cascade_size | maximize | 74.6667 | 100 | 25.3333 | 1.72856 | nabm_more_final_ceiling_hits | 0/1 | /4.33333 | 0/0 | 0/1 |
...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| toy5_readiness_propagation_hard_argmax | toy5 | neural_argmax_output_average | neural_argmax_readiness_propagation_w1p0 | 25.3333 | 1.72856 | nabm_more_final_ceiling_hits | 0/1 | /4.33333 | 0/0 | 0/1 |
