...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| toy4_noisy_rep_local_obs_stress | toy4 | final_mean_payoff | maximize | 0.6 | 0.6 | 0 | 0 | baseline_faster_to_ceiling | 1/1 | 15/30 | 0/0 | 1/1 |
...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: |
| toy4_noisy_rep_local_obs_stress | toy4 | rep_clean | rev_local_sustain_obs_noisy_s2p0 | 0 | 0 | baseline_faster_to_ceiling | 1/1 | 15/30 | 0/0 | 1/1 |
